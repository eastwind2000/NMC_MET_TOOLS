...
def setup_qpe5km_nmic(cdate_utc):
    ...
    qpedata = np.array( map(float, databufr) ).reshape(ny, nx)
    ...
    s00 = "netcdf QPE5KM_NMIC." + cdate_utc + "{" + "\n"
    ...
    s03 = " // global attributes: " + "\n" + \
          ...
          "	:Nlat = \"801 grid_points\" ; " + "\n" + \
          "	:Nlon = \"1401 grid_points\" ; " + "\n"
    ...
    s07 = "APCP_24 = " + ",".join(str(item) for item in qpedata.flatten()) + ";\n"

    s0x = " } \n"

    ##################################################

    im_ncfile_name = gv.result_dir + "im_qpe5km_ncfile.cdl"
    ...
    out_ncfile_name = gv.result_dir + "qpe5km_nmic_" + cdate_utc + ".nc"  # pay attention!
